...
namespace InterviewTraining.Infrastructure.Migrations
{
    ...
    [Migration("20260504183427_AddedIsExpertAvailableInSearch")]
    partial class AddedIsExpertAvailableInSearch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InterviewTraining.Domain.AdditionalUserInfo", b =>
                {
                    ...
                    b.Property<bool>("IsExpertAvailableInSearch")
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("InterviewTraining.Domain.InterviewChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("interview_chat_messages", "public");
                });
            ...
            modelBuilder.Entity("InterviewTraining.Domain.UserChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("user_chat_messages", "public");
                });

            modelBuilder.Entity("InterviewTraining.Domain.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("InterviewTraining.Domain.InterviewChatMessage", b =>
                {
                    b.HasOne("InterviewTraining.Domain.Interview", "Interview")
                        .WithMany("InterviewChatMessages")
                        .HasForeignKey("InterviewId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("InterviewTraining.Domain.AdditionalUserInfo", "SenderUser")
                        .WithMany()
            ...
            modelBuilder.Entity("InterviewTraining.Domain.UserChatMessage", b =>
                {
                    b.HasOne("InterviewTraining.Domain.AdditionalUserInfo", "ReceiverUser")
                        .WithMany()
            ...
            modelBuilder.Entity("InterviewTraining.Domain.Interview", b =>
                {
                    b.Navigation("InterviewChatMessages");
