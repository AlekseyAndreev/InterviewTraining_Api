...
public static class InterviewStatusDescription
{
    ...
    public static string GetStatusDescriptionRu(string status)
    {
        return status switch
        {
            ...
            InterviewStatus.ConfirmedByCandidate => "Подтверждено кандидатом, ожидает подтверждения экспертом",
            InterviewStatus.ConfirmedByExpert => "Подтверждено экспертом, ожидает подтверждения кандидатом",
    ...
    public static string GetStatusDescriptionEn(string status)
    {
        return status switch
        {
            ...
            InterviewStatus.ConfirmedByCandidate => "Confirmed by candidate, waiting expert approval",
            InterviewStatus.ConfirmedByExpert => "Confirmed by expert, waiting candidate approval",
