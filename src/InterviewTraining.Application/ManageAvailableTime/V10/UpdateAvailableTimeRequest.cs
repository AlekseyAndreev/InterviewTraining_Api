...
/// <summary>
/// Запрос на обновление записи доступного времени
/// </summary>
public class UpdateAvailableTimeRequest : IMediatorRequest<UpdateAvailableTimeResponse>
{
    /// <summary>
    ...
    /// <summary>
    /// Идентификатор записи доступного времени
    /// </summary>
